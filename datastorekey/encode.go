...
func ajaxEncode(w http.ResponseWriter, r *http.Request) {
	...
	log.Infof(c, "Encoded %v\n", keyString)
}

// See https://developers.google.com/appengine/docs/go/datastore/entities#Go_Kinds_and_identifiers
func CreateKey(c context.Context, appID string, namespace string, kind string, stringID string, intID int64, parent *datastore.Key) (*datastore.Key, error) {
